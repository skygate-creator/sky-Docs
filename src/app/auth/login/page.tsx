...
const login = () => {
  ...
  return (
    <section className="w-screen h-screen flex items-center justify-center px-5">
      <div className="grid sm:grid-cols-2 gap-2 bg-white rounded-2xl shadow-lg max-w-[1100px] mx-auto">
        ...
        <div className="relative hidden sm:block">
          <span className="absolute rounded-e-2xl top-0 left-0 w-full h-full bg-gradient-to-r from-primary-500 to-primary-900 opacity-50"></span>
          <Image
            src="/login_img.webp"
            alt="login"
            width={300}
